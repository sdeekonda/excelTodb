...
class ReadXls {
    ...
    public Map<Integer,Integer> columnLength = new HashMap<Integer, Integer>();
    public List<LinkedHashMap> result;

    public Map<Integer, Integer>getAnnotationsId(Map<Integer, String> annotations) {
                ...
                for (int i=currentRow.getFirstCellNum(); i<currentRow.getLastCellNum(); i++){
                    ...
                    switch (currentCell.getCellType()) {
                        case Cell.CELL_TYPE_STRING:
                            lHashMap.put(i, new String(currentCell.getRichStringCellValue().getString()));
